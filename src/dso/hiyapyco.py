"""Vendored version of the hiyapyco code, with some custom changes.

Derived from b25ab4f on 2024-06-12.
If this issue gets resolved, we can switch back to upstream code: https://github.com/zerwes/hiyapyco/issues/74
...
"""
# Don't reformat that file, to ensure it's still possible to diff it against the original version.
# fmt: off

...
-  Watermarks are now also added to interactive plotly plots in quarto reports, as a semi-transparent overlay that does not interfere with hovering data points

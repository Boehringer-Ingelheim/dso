...
-  Add `dso checkout` command as a wrapper around `dvc checkout`, compiling configuration before running ([#178](https://github.com/Boehringer-Ingelheim/dso/issues/179))

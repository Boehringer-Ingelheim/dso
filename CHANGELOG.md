...
-  Watermarks are now also added to interactive plotly plots in quarto reports, as a semi-transparent overlay that does not interfere with hovering data points ([#182](https://github.com/Boehringer-Ingelheim/dso/issues/182))
